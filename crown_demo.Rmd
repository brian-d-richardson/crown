...
res <- bind_rows(
  ...
  mutate(
    ...
    rd_ci_lower = rdhat - qnorm(0.975) * sqrt(var_rd),
    rd_ci_upper = rdhat + qnorm(0.975) * sqrt(var_rd),
    rr_ci_lower = rrhat - qnorm(0.975) * sqrt(var_rr),
    rr_ci_upper = rrhat + qnorm(0.975) * sqrt(var_rr),
